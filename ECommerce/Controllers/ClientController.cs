...
namespace ECommerce.Controllers
{
	...
	public class ClientController(ClientService _service) : ControllerBase
	{
		...
		[HttpGet]
		public ActionResult<List<ResponseClient>> GetAllClients(long id)
		{
		...
		public ActionResult<ResponseClient> CreateClient(CreateClientRequest request)
		{
		...
		[HttpPut("{id:long}")]
		public ActionResult<ResponseClient> UpdateClient(long id, UpdateClientRequest request)
		{
		...
		[HttpGet("{id:long}")]
		public ActionResult<ResponseClient> GetClientById(long id)
		{
